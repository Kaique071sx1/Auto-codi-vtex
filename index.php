  ...
  <style> 
    ...
    <div class="app-content content" style="display:block;background-color:#1f1f29;">
      <div class="content" style="background-color:#1f1f29;">
        <br>
    <h4 class="mb-2" style="text-align:center;"><strong>ferramenta vtex</strong></h4>
		...
		<div class="col-md-8">
			<div class="card" style="background-color:transparent;">
				<div class="card-body text-center">
					...
					<textarea rows="1" class="form-control text-center" style="width: 100%; float: left ; margin-bottom : 5px"  id="sitess" placeholder="URL SITE VTEX"></textarea>
					
				
				  <textarea rows="1"class="form-control text-center" style="width: 50%; float: left;margin-bottom: 15px;" id="ips" placeholder="IP:PORT"></textarea>
					<textarea rows="1"class="form-control text-center" style="width: 50%; float: right;margin-bottom: 15px;" id="pass" placeholder="USER:PASS"></textarea>
...
<h5>CVV/CCN :<span class="badge badge-success float-right cvvs">0</span></h5><hr class="hr-statusbar">
...
<footer class="footer-C"></a></footer>
<script>
...
$('.btn-copy2').click(function(){
	Swal.fire({title: 'COPIED CVV/CCN', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
...
if(!sitess){
	Swal.fire({title: 'You did not provide url vtex :(', icon: 'error', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
	return false;
}

Swal.fire({title: 'TRYING YOU CARD...', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
...
if(total > 2000){
  Swal.fire({title: 'FREE ACCESS  < 500 CCS', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
...
function() {
var callBack = $.ajax({
	url: 'api.php?lista=' + data + '&sitess=' + sitess + '&ips=' + ips + '&pass=' + pass,
